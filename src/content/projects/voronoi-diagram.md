...
[GitHub에서 보기](https://github.com/jiminu/voronoi-diagram)
...
보로노이 다이어그램은 $n$개의 시드 점에 대해 $n+1$개의 면(Face), 최대 $2n-2$개의 정점(Vertex), 최대 $3n-3$개의 간선(Edge)을 갖는다.
...
자료구조의 포인터를 따라가면 임의의 Face를 둘러싼 Bounding Edges를 간선 개수 $k$에 비례하는 $O(k)$ 시간에 한 바퀴 순회할 수 있다.
